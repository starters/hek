...
module.exports = NewForm('~/.hek/hek.json', [
  { key: 'github', title: "Your Github handle:",  default: process.env.USER, expect: { len:[1] }, forOnce: true },
  ...
  { key: 'starters', title: "Starter(s):", desc: 'e.g: hek/redux-starter, hek/go-api-starter', default: '', commaList: true }
]);
